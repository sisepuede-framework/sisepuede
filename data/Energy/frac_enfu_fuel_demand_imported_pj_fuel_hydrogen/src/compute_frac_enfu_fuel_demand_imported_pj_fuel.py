...
#var_energy_to_process = "frac_enfu_fuel_demand_imported_pj_fuel_coal"
# Set directories
...
for energy, cw_params in correspondencias_web_sisepuede["frac_enfu_fuel_demand_imported_pj"].items():
    if cw_params:
        cw,params = cw_params
...
lousiana_energy_long = lousiana_energy[["ssp_var", "frac_imports"]].set_index("ssp_var").T.reset_index(drop=True)
