#set up root folder
 root <- r"(C:\Users\edmun\OneDrive\Edmundo-ITESM\3.Proyectos\59. Lousiana Project\sisepuede\data\SocioEconomic\population_gnrl_urban\)"
...
#write files to repo 
#urban 
  variable <- "population_gnrl_urban"
